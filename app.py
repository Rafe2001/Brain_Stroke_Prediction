...
model = pickle.load(open('model_brain.pkl', 'rb'))
...
def main():
    ...
    if st.button("Predict Stroke"):
        ...
        features = [gender,age, hypertension, heart_disease, avg_glucose_level, bmi, smoking_status, ever_married, Residence_type]
